...
<?php echo $this->Form->create('IdfSubmission'); ?>
	<fieldset>
		<legend><?php echo __('Edit Idf Submission'); ?></legend>
	<?php
		...
		echo $this->Form->input('submit_Location_id');
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('IdfSubmission.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('IdfSubmission.id'))); ?></li>
